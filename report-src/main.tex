...
\begin{abstract}
  ...
  aimed at significantly improving final answer accuracy on the MathArena benchmark suite, including AIME, HMMT, BRUMO, SMT and CMIMC all for 2025.
...
Our experiments on the MathArena benchmark demonstrate that the PCAF architecture yields a quantifiable improvement in reliability compared to the Matharena's standard one-shot approach defined in the benchmark's evaluation protocol \cite{MathArena2025}.
