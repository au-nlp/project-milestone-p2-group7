...
\textbf{Persistent Environment:}
  ...
  within a single Solver attempt. This enables complex, multiblock
...
=======
The Solver: Reference get\_solver\_prompt. Explain the "Two Strictly Different Methods" mandate (Analytical vs. Naive Brute-Force) and the "Code-First Mandate".
>>>>>>> 4477580 (Fixed latex errors)



The Verifier: Reference VERIFIER\_ROLE and VERIFIER\_JSON\_SCHEMA. Explain how it acts as a "Skeptical Math Auditor" looking for specific error categories (LOGIC\_FLAW, METHOD\_CONFLICT, VALUE\_MISMATCH).

The Planner: Reference construct\_planner\_feedback. Explain the deterministic routing logic. Highlight how it translates a JSON error into a specific instruction (e.g., “If VALUE\_MISMATCH -> Wipe memory, re-calculate”).
