...
\begin{table}[h]
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    \textbf{Global Average} & \textbf{39.5\%*} & \textbf{53.65\%} & \textbf{38.9\%} & \textbf{2.24} \\
    \bottomrule
